...
function to_xml_book($arg){
	...
	// files open
	$file1 = fopen("E:/xampp/tomcat\webapps\pro_b/static/neo/".$arg, "r");

	while (!feof($file1)) {

		$str = fgets($file1);

		$str = str_replace("&","&amp;",$str);		// Replace escape character
		...
		if (!(strpos($str, "sigschapter")===false)) {
			...
			if ($item) {		//after second item with style of Chapter.

				// register the previous "item" to "book->body" with new key name.
				$key_name = "item".$item_num;		// This is for xml serializer.
	...
	//At the end of the line, you should input, item and page, reversely.
	...
	//file close. 
	fclose($file1);
	$result = $xml->generateValidXmlFromObj($book, "book");
	echo $result;
...
function font_option($val01, $val02){
	...
	// files open
	$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xsl/fiction_attribute.xsl", "r");
...
$file = "E:/xampp/tomcat/webapps/pro_b/xml/auth.xml";
...
function gut_wrap(){
	$dom = new DOMDocument();
	$dom->load("E:/xampp/tomcat/webapps/pro_b/xml/book_fiction.xml");
...
*****************/
	...
	$dom->save("E:/xampp/tomcat/webapps/pro_b/xml/book_fiction.xml");



	//$simple = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/xml/book_fiction.xml");	
...
function combine(){
	...
	$simple02 = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/xml/book_fiction.xml");
	$simple01 = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/xml/fiction_front.xml");
	$simple03 = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/xml/fiction_back.xml");
	...
	$dom->save("E:/xampp/tomcat/webapps/pro_b/xml/second.xml");
	...
	$dom->formatOutput = true;
	$dom->preserveWhiteSpace = false;
	$dom->load("E:/xampp/tomcat/webapps/pro_b/xml/second.xml");
...
function default_base(){
	...
	// open file
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml", 'w');

	fputs($file2, "<defaults>".PHP_EOL);

	$obj = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml");
	...
	// load file
	$obj = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/static\default_set/default.xml");
	$obj02 = simplexml_load_file("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml");
...
*******************/
	...
	// save as xml
	$obj02->asXml('E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml');
	...
	$dom->load("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml");
	...
	************************/
	$xml = $dom->save("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml");
	/////////////////////////////////////

	/////////////////////// Step 3 last step
	// from 'default_base.xml' to 'default.xml' in reverse.
	$temp = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_base.xml");
	file_put_contents("E:/xampp/tomcat/webapps/pro_b/static\default_set/default.xml", $temp);
}
...
function save_default(){
	// read default.xml
	$data = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static\default_set/default.xml");

	// write to default_reserve.xml
	file_put_contents("E:/xampp/tomcat/webapps/pro_b/static\default_set/default_reserve.xml", $data);
	//echo "hello default";
}
...
function to_default($arg01, $arg02){
	...
	// files open
	$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/default_set/default.xml", "r");
...
function default_setting(){		
	...
	$xmlstring = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static/default_set/default.xml");
...
function distinct_tags(){
	$str02 = "";
	// files open
	$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml", "r");
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/xml/hello.xml", "w");
...
function c_fiction_fo(){
	// files open
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/xsl/fiction_fo.xsl", "w");	


/************************/
	// xsl header
	$header = file_get_contents("E:/xampp/tomcat/webapps/pro_b/xsl/fiction_h.xsl", "r");
	$header .= PHP_EOL;
	$header .= file_get_contents("E:/xampp/tomcat/webapps/pro_b/xsl/fiction_h2.xsl", "r");
	...
	$str .= file_get_contents("E:/xampp/tomcat/webapps/pro_b/xsl/fiction_h3.xsl", "r");
...
function c_underhood(){
	...
	// files open
	$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml", "r");
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/xsl/fiction_underhood.xsl", "w");	
	...
	while (!feof($file1)) {
		...
		if (!(strpos($str, "<book>")===false)) {
			...
			$header = file_get_contents("E:/xampp/tomcat/webapps/pro_b/xsl/match/match_book.xsl", "r");
...
function c_attribute(){
	// files open
	$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml", "r");
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xsl/fiction_attribute.xsl", "w");	
...
function get_tags_from_fiction_xml(){
	$file = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/temp.xml", "w");
	...
	$str = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static/xml/temp.xml");
...
function fiction_parser(){
	...
	$file = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml", "w");
	...
	$tags = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static\default_set/tag_add.xml");
...
function page_master_tag($file){
	...
	// file open
	$file1 = fopen("E:/xampp/tomcat\webapps\pro_b/xsl/fiction_fo.xsl", "r");
...
// creates "E:/xampp/tomcat/webapps/pro_b/static\js/fiction_interfere.js
function fiction_interfere(){

	// files open
	//$file1 = fopen("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml", "r");
	$file2 = fopen("E:/xampp/tomcat/webapps/pro_b/static/js/fiction_interfere.js", "w");

	$xmlstring = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static/xml/fiction_tag.xml");

	$xml = simplexml_load_string($xmlstring);	

	//print_r($xml);
	$str = file_get_contents("E:/xampp/tomcat/webapps/pro_b/static\js/fiction_js_h.js");
